import type { init as baseInit, EChartsType as BaseEchartsType, EChartsOption, SetOptionOpts } from 'echarts';
...
} & EventHandlers & OmitHandlers<HTMLAttributes<HTMLDivElement>>;
export {};
